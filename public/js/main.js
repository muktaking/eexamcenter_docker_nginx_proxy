                ...
                if(e.type === "matrix"){
                    ...
                    <ul class="list-group" id="list-group-${i}">
                        <li class="list-group-item active text-center">
                            Answer and Explanation For Question no. <span class="badge badge-light">${i+1}</span>. <p>Ques: ${e.text}</p> Mark Obtained: <span class="badge ${Number(e.score ) > .50 ? "badge-success" : "badge-danger"}">${e.score}</span>
                        </li>
                    </ul>
